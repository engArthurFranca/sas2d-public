<template>
    <div class="relative inline-block text-left mr-4" id="selectModel">
        <button @click="trigger" :class="props.buttonClass" class="inline-flex items-center p-0 m-0 border border-gray-300 rounded-md bg-white text-sm font-medium text-gray-700 hover:text-gray-500 focus:outline-none focus:ring focus:border-blue-300 active:bg-gray-100 active:text-gray-800 transition">
